...
var documents = [{
    "id": 0,
    "url": "https://manuhg.github.io/404.html",
    "title": "",
    "body": " 404 Page not found :(  The requested page could not be found. "
    }, {
    "id": 1,
    "url": "https://manuhg.github.io/about/",
    "title": "About Me",
    "body": "visit manuhegde. in "
    }, {
    "id": 2,
    "url": "https://manuhg.github.io/categories/",
    "title": "Tags",
    ...
    "id": 5,
    "url": "https://manuhg.github.io/2020/03/03/pytorch-at-telsa.html",
    "title": "Pytorch at Tesla",
    "body": "2020/03/03 - This is an old video back in nov 2019.  They use their own homegrown HydraNet     (2,960,1280) meaning 1280x960 colour images (video frames) with ResNet-50 like dilated backbones   FPN/DeepLab/Unet heads for ~15 tasks   fyi hydra is a mythiological serpant monster that has one body and many heads    8 Hydra nets for 8 cameras.      they make basic detections like road edge, side roads, markings, vehicles etc   this data is then taken and stitched together by another recurrent net to produce a larger understanding of the environment i. e like the layout of the area, where are the cross/side roads, etc.    i. e for ex: right camera sees a road, then that means there is a road perpendicular to the current road    all tasks are trained in parallel on a async pool of worker nodes     For autopilot 2. 0: 48 networks, 1000 predictions, 72,000 gpu hours   operation vacation: if data is labelled regularly, everything else is automated (so essesntially engineers can go on vacay)    operational stats:     50,000+ smart summon sessions   1 Bn miles, 200,000 auto lane changes across 50+ countries    Hydranet Overview Misc:  Tesla’s FSD - Full Self Driving (Capabality) dojo - area of training (originally judo but generally all experiments, setting hair on fire etc?)Images: Operation Vacation FSD Computer Source: Pytorch at Tesla "
    }, {
    "id": 6,
    "url": "https://manuhg.github.io/2020/02/26/weight-agnostic-neural-networks.html",
    "title": "Weight agnostic neural networks",
    "body": "2020/02/26 - Notes:  kinda like specialized tissues (cells that differentiate from others and are meant to do one particular thing ex: skin cells). being good at doing something (at least better than others ) from birth/creation with no prior training/experience hence can perform a task to a good extent even with random weights ensembles of this model with different sets of random weightsLinks:  The paper Google AI Blog Demo other links: towardsdatascience"
    }, {
    "id": 7,
    "url": "https://manuhg.github.io/fastpages/jupyter/2020/02/20/test.html",
    ...
    "id": 8,
    "url": "https://manuhg.github.io/fastpages/markdown/2020/01/14/test-markdown-post.html",
